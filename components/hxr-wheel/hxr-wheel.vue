  ...
  <view class="wheel_wp sol-class">
    <block v-if="mode == 1">
      ...
      <view class="wheel_pointer" @tap="start" :style="'-webkit-transform:rotate(' + deg + 'deg) translateZ(0);transform:rotate(' + deg + 'deg) translateZ(0)'">
        <image src="../s-dial_pointer.png"></image>
      </view>
    </block>
    <block v-if="mode == 2">
      <image src="../s-dial_bg.png" :style="'-webkit-transform:rotate(' + deg + 'deg) translateZ(0);transform:rotate(' + deg + 'deg) translateZ(0)'"></image>
