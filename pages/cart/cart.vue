	...
	<view class="cart">
		<view v-if="cartList.length === 0" class="empty">
			...
			<view v-else class="empty-tips">
				空空如也
				<view class="navigator" @tap="navTo('/pages/public/logintype')"
					>登录/注册 ></view
				>
			</view>
		</view>
		...
		<view class="goods-list">
			<view class="btn-clear" @tap="clearCart({ lose_status: 1 })"
				>清空失效商品</view
			>
		...
		>
			...
			<view
				...
				>删除</view
			>
			<view class="delBtn" @tap="clearCart()" v-if="selectedList.length > 0"
				>清空</view
			>
...
// 	productDetail
// } from '@/api/product';
import attrContent from '@/components/product-attr-content/index.vue';
// import { mapMutations } from 'vuex';
export default {
  components: { attrContent },
	data() {
		return {
			sumPrice: '0.00',
